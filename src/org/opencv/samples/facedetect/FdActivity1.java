...
public class FdActivity1 extends Activity implements CvCameraViewListener2 {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.face_detect_surface_view2);
		...
		backbtn.setOnClickListener(new Button.OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				intent.setClass(FdActivity1.this, HomeActivity.class);
				startActivity(intent);
				FdActivity1.this.finish();
			}
		...
		switch1.setOnClickListener(new Button.OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent = new Intent();
				intent.setClass(FdActivity1.this, FdActivity2.class);
				startActivity(intent);
				FdActivity1.this.finish();
			}
	...
	private Mat get_template(CascadeClassifier clasificator, Rect area, int size) {
		...
		clasificator.detectMultiScale(mROI, eyes, 1.15, 2,
				Objdetect.CASCADE_FIND_BIGGEST_OBJECT
						| Objdetect.CASCADE_SCALE_IMAGE, new Size(1.0, 2.0),
				new Size());
