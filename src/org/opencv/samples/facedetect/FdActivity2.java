...
public class FdActivity2 extends Activity implements CvCameraViewListener2 {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.face_detect_surface_view3);
		...
		backbtn.setOnClickListener(new Button.OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				intent.setClass(FdActivity2.this, HomeActivity.class);
				startActivity(intent);
				FdActivity2.this.finish();
			}
			
		});
		
		Button switch2 = (Button) findViewById(R.id.switch2);
		switch2.setOnClickListener(new Button.OnClickListener(){

			@Override
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent = new Intent();
				intent.setClass(FdActivity2.this, FdActivity1.class);
				startActivity(intent);
				FdActivity2.this.finish();
			}
